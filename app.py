...
# EC-AI Institutional Relationship OS v10.0.3 Alpha
# v9.2: Real Top 10 S&P universe + MAS v1.2 + MAS explainability + top executive pack export
# Run:
#   python -m streamlit run ecai_institutional_relationship_os_v10_0_3_alpha.py
...
st.set_page_config(
    page_title="EC-AI Institutional Relationship OS v10.0.3 Alpha",
    page_icon="🏦",
    layout="wide",
)
