...
# EC-AI Institutional Relationship OS v9.4.1
...
st.set_page_config(
    page_title="EC-AI Institutional Relationship OS v9.4.1",
    page_icon="🏦",
    layout="wide",
)
...
def build_portfolio_memo(data):
    ...
    lines.append("")
    lines.append("---")
    lines.append("Generated by EC-AI Institutional Relationship OS v9.4.1 | MAS v1.2")
    return "\n".join(lines)
...
def build_relationship_memo(row):
    ...
    lines.append("")
    lines.append("---")
    lines.append("Generated by EC-AI Institutional Relationship OS v9.4.1")
    return "\n".join(lines)
...
def build_executive_pack_pdf(data, selected_company=None):
    ...
    story.append(Spacer(1, 10))
    story.append(Paragraph("Generated by EC-AI Institutional Relationship OS v9.4.1 | Management Attention Allocation System", styles["ECSmall"]))
    doc.build(story)
    return buf.getvalue()
...
st.markdown("""
<div class="ec-hero">
  <div class="ec-title">EC-AI Institutional Relationship OS v9.4.1</div>
...
st.markdown("---")
st.caption("EC-AI Institutional Relationship OS v9.4.1 | Management Attention Allocation System (MAS) v1.2 | Real S&P Top 10 Public Company Universe")
