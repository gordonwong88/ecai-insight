...
# EC-AI Institutional Relationship OS v10.0.4 Alpha
# v9.2: Real Top 10 S&P universe + MAS v1.2 + MAS explainability + top executive pack export
# Run:
#   python -m streamlit run ecai_institutional_relationship_os_v10_0_4_alpha.py
...
st.set_page_config(
    page_title="EC-AI Institutional Relationship OS v10.0.4 Alpha",
    page_icon="🏦",
    layout="wide",
)
...
/* v10.0.4: narrower, readable sidebar controls */
section[data-testid="stSidebar"] { width: 232px !important; min-width: 232px !important; }
section[data-testid="stSidebar"] > div { width: 232px !important; }
...
[data-testid="stSidebar"] .stDownloadButton button *,
[data-testid="stSidebar"] [data-testid="stBaseButton-secondary"] * { color:#071B3A !important; }
[data-testid="stSidebar"] [data-testid="stFileUploaderDropzone"] {
    background:#F8FAFC !important;
    border:1px dashed #9FB3CC !important;
}
[data-testid="stSidebar"] [data-testid="stFileUploaderDropzone"] *,
[data-testid="stSidebar"] [data-testid="stFileUploaderDropzoneInstructions"] * { color:#071B3A !important; }
[data-testid="stSidebar"] [data-testid="stFileUploader"] small { color:#D7E3F1 !important; }
.sidebar-mas-note { background:rgba(255,255,255,.09); border:1px solid rgba(255,255,255,.18); border-radius:10px; padding:10px 11px; font-size:12.5px; line-height:1.4; margin-top:7px; }
...
def build_portfolio_memo(data):
    ...
    lines.append("")
    lines.append("---")
    lines.append("Generated by EC-AI Institutional Relationship OS v10.0.4 Alpha | MAS v1.2")
    return "\n".join(lines)
...
def build_relationship_memo(row):
    ...
    lines.append("")
    lines.append("---")
    lines.append("Generated by EC-AI Institutional Relationship OS v10.0.4 Alpha")
    return "\n".join(lines)
...
def build_executive_pack_pdf(data, selected_company=None):
    ...
    story.append(Spacer(1, 10))
    story.append(Paragraph("Generated by EC-AI Institutional Relationship OS v10.0.4 Alpha | Management Attention Allocation System", styles["ECSmall"]))
    doc.build(story)
    return buf.getvalue()
...
# =========================
# Relationship 360 Helpers v10.0.4 Alpha
# =========================
...
st.sidebar.markdown("**v10.0.4 Alpha**")
st.sidebar.markdown("---")
...
st.sidebar.download_button(
    ...
    file_name="ecai_v10_0_4_wallet_input_template.csv",
    mime="text/csv",
...
st.sidebar.markdown(
    """<div class="sidebar-mas-note"><b>MAS = Management Attention Score</b><br>It prioritises where management should focus. It is not a credit rating or risk score.</div>""",
    unsafe_allow_html=True,
)
...
st.markdown("""
<div class="ec-hero">
  <div class="ec-title">EC-AI Institutional Relationship OS v10.0.4 Alpha</div>
...
with exp1:
    st.download_button("📄 Generate Executive Pack PDF", data=_top_pdf, file_name="ecai_institutional_relationship_os_v10_0_4_alpha_executive_pack.pdf", mime="application/pdf", use_container_width=True)
with exp2:
    st.download_button("⬇️ Download MAS Scorecard CSV", data=df.to_csv(index=False).encode("utf-8"), file_name="ecai_mas_v1_2_top10_relationships_v10_0_4_alpha.csv", mime="text/csv", use_container_width=True)
...
with tab_queue:
    ...
    st.markdown("""
    <div class="ec-note">
      <b>How to interpret MAS</b><br>
      MAS stands for <b>Management Attention Score</b>. It ranks relationships by the level of management focus required, combining opportunity and risk signals across five pillars. A higher score does <b>not</b> automatically mean higher credit risk; it may reflect strategic importance, an under-captured wallet, weakening relationship health, insufficient senior coverage or emerging risk signals. The score is designed to answer: <b>“Which relationships require management attention now, and why?”</b>
    </div>
    """, unsafe_allow_html=True)
...
with tab_memo:
    ...
    with c1:
        st.download_button("Generate Executive Pack PDF", data=pdf, file_name="ecai_institutional_relationship_os_v10_0_4_alpha_executive_pack.pdf", mime="application/pdf", use_container_width=True)
    with c2:
    ...
    with c3:
        st.download_button("Download Memo Text", data=memo_text.encode("utf-8"), file_name="ecai_v10_0_4_alpha_management_memo.txt", mime="text/plain", use_container_width=True)
...
st.markdown("---")
st.caption("EC-AI Institutional Relationship OS v10.0.4 Alpha | Management Attention Allocation System (MAS) v1.2 | Real S&P Top 10 Public Company Universe")
