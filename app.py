...
# EC-AI Institutional Relationship OS v3.1
# v3.1: Executive Action Queue + PDF memo export + improved readability
# Run:
#   python -m streamlit run ecai_institutional_relationship_os_v3_1.py
...
/* v3.1 executive section header upgrade */
.ec-section-title {
...
def build_ai_reasoning_narrative(row):
    """Rule-based AI reasoning narrative v3.1: explains why management should care."""
...
def build_management_memo(data):
    ...
    lines.append("")
    lines.append("---")
    lines.append("Generated by EC-AI Institutional Relationship OS v3.1")
    return "\n".join(lines)
...
def build_management_memo_pdf(data) -> bytes:
    ...
    for raw in memo.splitlines():
        ...
        if safe.startswith("# "):
            ...
            story.append(Paragraph("Generated by EC-AI Institutional Relationship OS v3.1", styles["ECSmall"]))
        else:
            story.append(Paragraph(safe, styles["ECBody"]))
...
with header_left:
    ...
    st.markdown(
        '<div class="sub-title">Executive view of institutional relationships | EC-AI Synthetic Institutional Portfolio Dataset v3.1</div>',
        unsafe_allow_html=True,
    )
...
st.markdown(
    """
    <div class="ai-box">
    <b>Management Priority Score v3.1 Formula</b><br><br>
...
st.download_button(
    ...
    file_name="ecai_executive_action_queue_v3_1.csv",
    mime="text/csv",
...
try:
    ...
    st.download_button(
        ...
        data=r360_pdf,
        file_name=f"ecai_relationship_360_{selected_360.replace(' ', '_').lower()}_v3_1.pdf",
    ...
    st.download_button(
        ...
        file_name=f"ecai_relationship_360_{selected_360.replace(' ', '_').lower()}_v3_1.txt",
        mime="text/plain",
        use_container_width=False,
    )
...
with memo_col2:
    ...
    try:
        ...
        st.download_button(
            ...
            data=memo_pdf,
            file_name="ecai_institutional_portfolio_management_memo_v3_1.pdf",
            mime="application/pdf",
            use_container_width=True,
        )
    except Exception as e:
        ...
        st.download_button(
            ...
            file_name="ecai_institutional_portfolio_management_memo_v3_1.txt",
            mime="text/plain",
            use_container_width=True,
        )
    st.download_button(
        ...
        file_name="ecai_ai_management_action_table_v3_1.csv",
        mime="text/csv",
        use_container_width=True,
    )
...
st.markdown("---")
st.caption("EC-AI Institutional Relationship OS v3.1 | Executive Intelligence Layer + AI Management Action Engine + Relationship 360 Intelligence + Management Memo Generator")
