...
# EC-AI Institutional Relationship OS v3.2
# v3.2: Executive Action Queue + PDF memo export + improved readability
# Run:
#   python -m streamlit run ecai_institutional_relationship_os_v3_2.py
...
/* v3.2 executive section header upgrade */
.ec-section-title {
...
def build_ai_reasoning_narrative(row):
    """Rule-based AI reasoning narrative v3.2: explains why management should care."""
...
def build_management_memo(data):
    ...
    lines.append("")
    lines.append("---")
    lines.append("Generated by EC-AI Institutional Relationship OS v3.2")
    return "\n".join(lines)
...
def build_management_memo_pdf(data) -> bytes:
    ...
    for raw in memo.splitlines():
        ...
        if safe.startswith("# "):
            ...
            story.append(Paragraph("Generated by EC-AI Institutional Relationship OS v3.2", styles["ECSmall"]))
        else:
            story.append(Paragraph(safe, styles["ECBody"]))
...
st.markdown(
    '<div class="sub-title">Executive view of institutional relationships | EC-AI Synthetic Institutional Portfolio Dataset v3.2</div>',
    unsafe_allow_html=True,
)
...
pcol1, pcol2 = st.columns([1.05, 3.95], gap="large")
...
st.markdown(
    """
    <div class="ai-box">
    <b>Management Priority Score v3.2 Formula</b><br><br>
...
# =========================
section_title("Executive Action Queue", "Prioritized relationship actions for senior management follow-up.")
st.markdown(
    """
    <div class="narrative-box">
...
st.download_button(
    ...
    file_name="ecai_executive_action_queue_v3_2.csv",
    mime="text/csv",
...
try:
    ...
    st.download_button(
        ...
        data=r360_pdf,
        file_name=f"ecai_relationship_360_{selected_360.replace(' ', '_').lower()}_v3_2.pdf",
    ...
    st.download_button(
        ...
        file_name=f"ecai_relationship_360_{selected_360.replace(' ', '_').lower()}_v3_2.txt",
        mime="text/plain",
        use_container_width=False,
    )
...
with memo_col2:
    ...
    try:
        ...
        st.download_button(
            ...
            data=memo_pdf,
            file_name="ecai_institutional_portfolio_management_memo_v3_2.pdf",
            mime="application/pdf",
            use_container_width=True,
        )
    except Exception as e:
        ...
        st.download_button(
            ...
            file_name="ecai_institutional_portfolio_management_memo_v3_2.txt",
            mime="text/plain",
            use_container_width=True,
        )
    st.download_button(
        ...
        file_name="ecai_ai_management_action_table_v3_2.csv",
        mime="text/csv",
        use_container_width=True,
    )
...
st.markdown("---")
st.caption("EC-AI Institutional Relationship OS v3.2 | Executive Intelligence Layer + AI Management Action Engine + Relationship 360 Intelligence + Management Memo Generator")
