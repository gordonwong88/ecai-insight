...
# EC-AI Institutional Relationship OS v2.2
# v2.2: Executive Action Queue + PDF memo export + improved readability
# Run:
#   python -m streamlit run ecai_institutional_relationship_os_v2_2.py
...
def build_management_memo(data):
    ...
    lines.append("")
    lines.append("---")
    lines.append("Generated by EC-AI Institutional Relationship OS v2.2")
    return "\n".join(lines)
...
def build_management_memo_pdf(data) -> bytes:
    ...
    for raw in memo.splitlines():
        ...
        if safe.startswith("# "):
            ...
            story.append(Paragraph("Generated by EC-AI Institutional Relationship OS v2.2", styles["ECSmall"]))
        else:
            story.append(Paragraph(safe, styles["ECBody"]))
...
with header_left:
    ...
    st.markdown(
        '<div class="sub-title">Executive view of institutional relationships | EC-AI Synthetic Institutional Portfolio Dataset v2.2</div>',
        unsafe_allow_html=True,
    )
...
st.markdown(
    """
    <div class="ai-box">
    <b>Management Priority Score v2.2 Formula</b><br><br>
...
st.download_button(
    ...
    file_name="ecai_executive_action_queue_v2_2.csv",
    mime="text/csv",
...
st.download_button(
    ...
    file_name=f"ecai_relationship_360_{selected_360.replace(' ', '_').lower()}_v2_2.md",
    mime="text/markdown",
    use_container_width=False,
)
...
with memo_col2:
    ...
    try:
        ...
        st.download_button(
            ...
            data=memo_pdf,
            file_name="ecai_institutional_portfolio_management_memo_v2_2.pdf",
        ...
        st.download_button(
            ...
            file_name="ecai_institutional_portfolio_management_memo_v2_2.txt",
            mime="text/plain",
            use_container_width=True,
        )
    st.download_button(
        ...
        file_name="ecai_ai_management_action_table_v2_2.csv",
        mime="text/csv",
        use_container_width=True,
    )
...
st.markdown("---")
st.caption("EC-AI Institutional Relationship OS v2.2 | Executive Intelligence Layer + AI Management Action Engine + Relationship 360 Intelligence + Management Memo Generator")
